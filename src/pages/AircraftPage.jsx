                ...
                <table className="min-w-full mt-4 border-collapse border border-gray-300">
                    <thead className="bg-gray-50">
                        <tr>
                            ...
                            <th className="border border-gray-300 px-4 py-2 text-left">Rango Máximo</th>
                            <th className="border border-gray-300 px-4 py-2 text-left">Velocidad</th>
                    ...
                    <tbody>
                        {aircraftData.map((aircraft) => (
                            <tr key={aircraft.id} className="hover:bg-gray-50">
                                ...
                                <td className="border border-gray-300 px-4 py-2 text-center">{aircraft.passengerCapacity}</td>
                                <td className="border border-gray-300 px-4 py-2 text-right">{aircraft.maxRange?.toLocaleString()} km</td>
                                <td className="border border-gray-300 px-4 py-2 text-right">{aircraft.cruisingSpeed} km/h</td>
